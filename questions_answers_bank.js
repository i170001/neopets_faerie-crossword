const answers = {
  ...
  "_____boy Boots, for fashionable stomping":	"kau",
  ...
  "Brynn's homeland":	"brightvale",
  "Build Your Own Toy ___ Gelert Play Set":	"robot",
  ...
  "Captain and owner of the Golden Dubloon restaurant":	"hackett",
  "Captain of the Golden Dubloon":	"hackett",
  "Captain of the Faerieland Guard":	"brynneth",
  ...
  "Carried the Clockwork Negg to Shenkuu":	"rutu",
  "Carrot ____; book where carving carrots is an art":	"sculpture",
  "Carrotberry _____":	"smash",
  "Causes Krawk petpets to become pets":	"fungus",
  "Cave-exploring Usul":	"hannah",
  "Caves Spotlight; plot Hannah's doom in space":	"kreludor",
  "Celery Pen; good for writing and ___":	"salad",
  ...
  "Cherry lollypop with a surprise inside":	"aboogala",
  ...
  "Classmate of AAA; participated in Daily Dare":	"chadley",
  "Clear the screen of Evil Fuzzles with one of these":	"smartbomb",
  "Clever Zafara":	"sarah",
  "Clicking on your NP at the top takes you to your ___":	"inventory",
  ...
  "Clothes ___; icon for wearable items":	"hanger",
  "Cloudlike Petpetpet":	"strale",
  "Cloudy Wand of ___; battle magic":	"storms",
  "Club for eaters of rare food":	"gourmet",
  "Club; Sir Edmund Ogletree is a member":	"food",
  ...
  "Collect for points in Assignment 53":	"nerkmids",
  "Collect pieces of these for a secret location":	"map",
  "Collectable ___; where to find treasures of The Deep":	"seashells",
  "Collectable ____; how many are in YOUR NeoDeck?":	"card",
  "Collectable card; a Kau floating over Neopia":	"dreaming",
  "Collected in an album; ___ of the Deep":	"treasures",
  "Colour of 2 Gallon Hatz Ticket":	"brown",
  "Colour of 8-Bit Grundo Shirt":	"orange",
  "Colour of a baby Ruki's antennae":	"green",
  "Colour of a desert Eyrie's beak":	"blue",
  "Colour of a Moehug":	"purple",
  "Colour of a Stealthy Neopet's eyes":	"blue",
  "Colour of Anshu's moustache":	"white",
  "Colour of Greeble with pink eyes":	"yellow",
  "Colour of Hippalop; wears pants":	"halloween",
  ...
  "Colour of Techos banned from the Chocolate Ball":	"swampgas",
  "Colour of the Adorable Chomby Shirt and Trousers":	"pink",
  "Colour of the Altador Cup Practice Team":	"jelly",
  ...
  "Colour of the Rainbow Aisha's collar":	"red",
  ...
  "Contest; funny pictures that need a joke":	"caption",
  "Conundrum master":	"lenny",
  "Conveniently, Controlling Your Fire is ___proof":	"fire",
  "Coolest boots in Neopia":	"wellington",
  "Coral _____; only for use by water creatures":	"orb",
  "Coral Pan Flute; sounds best played ___":	"underwater",
  ...
  "Crater Fruit ___; cures Pollenitus":	"elixir",
  ...
  "Cured by using a Fuzzy Pink Blanket":	"jitters",
  "Cures D'achoo":	"neopkins",
  "Cures for this found at the Pharmacy":	"disease",
  "Cures Sneezles":	"magiccookie",
  "Currency of the site":	"neopoints",
  "Current king of Qasala":	"jazan",
  "Cursed Acara":	"vira",
  "Cursed Kyrii King of Qasala":	"jazan",
  "Cursed Qasalan ___; eat syrup bottles":	"pancakes",
  ...
  "Dargil Meat; not a meat but a ___":	"fruit",
  ...
  "Day of the week when Storytelling Contest begins":	"monday",
  "Deadly Pugio; good when your ___ fails":	"sword",
  "Decaf Darigan ___; perfect before bedtime":	"coffee",
  ...
  "Defeat this king in Castle Battles":	"skarl",
  ...
  "Diplomatic status of Brightvale":	"peaceful",
  "Directly east of Maraqua":	"moltara",
  "Director of the Neopian Pound":	"msworley",
  "Dirt is Your ___; according to a Moltaran book":	"friend",
  "Disco Petpet released for Neopets 12th Birthday":	"patamoose",
  ...
  "Dome of the ___; fight the Giant Spectral Mutant Walein":	"deep",
  ...
  "Edible pink tree":	"candyfloss",
  "Eerie ___ Scroll; resembles a Desert Petpet":	"sutekh",
  "Effect of the steak powerup in Ugga Smash":	"turbo",
  "Eggs on Rock: high in ___":	"minerals",
  "Eggy ___; Raw eggs, flakes of corn, and milk":	"weggs",
  ...
  "Elephante ___ Wig; looks nice with a mandolin":	"bard",
  "Elephante _____ Suit":	"peanut",
  "Elephante announcer for the Neopies":	"ellsworth",
  "Elephante Ballerina Rose; a gift from a ___":	"fan",
  ...
  "Eliv ___; loves anagrams":	"thade",
  "Elon ___; captain of the Maraquan Altador Cup team":	"hughlis",
  ...
  "Entire ___; not actual prize of the Customisation Spotlight":	"universe",
  ...
  "Event held for Poogle Day":	"parade",
  ...
  "Evil Popcorn: covered in ___ butter":	"rancid",
  "Evil scroll":	"dark",
  ...
  "Eye gear in the Geared Up Grundo outfit":	"goggles",
  ...
  "Faerie Cloud Meringues; clouds you can ___":	"eat",
  "Faerie cupcake with a tail":	"water",
  "Faerie in charge of the Negg Festival":	"kari",
  ...
  "Faerie type that has no wings":	"water",
  ...
  "Leader of the Thieves Guild":	"kanrik",
  "Leaders of the Awakened":	"twins",
  ...
  "Light faerie; 'First to Rise'":	"siyana",
  "Lightning ___; member of the Defenders of Neopia":	"lenny",
  "Lightning _____; Lightweight":	"gun",
  "Like a fruity paint brush for Chias":	"chiapop",
  "Like a muffin, but better!":	"cupcake",
  "Light Faerie Cereal; a ___ way to start the day":	"bright",
  "Lily Pad Notebook; great when you need a ___ of paper":	"pad",
  "Limited edition Meridell Neopet":	"draik",
  "Limited Edition Neopet from Tyrannia":	"tonu",
  "Lion PetPet":	"noil",
  ...
  "Location of the Ice Caves":	"glacier",
  ...
  "Negg ___ - Delicious Alternative Energy":	"delicious alternative energy",
  "Negg known for its rotten Battledome tricks":	"power",
  ...
  "Neopian Company; stock symbol is five letters":	"eeeee",
  ...
  "This Krawk had a chilling tale for Torchio":	"frostbite",
  ...
  "Tiki Tack Man's famous game":	"tombola",
  ...
  "What a Dust Mote makes an opponent do":	"sneezea",
